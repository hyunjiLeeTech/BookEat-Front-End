      ...
      <MainContainer>
        ...
        <div className="container">
          <div className="page-header text-center">
            ...
            <p>{this.state.isError.firstname}</p>
            <p>{this.state.isError.firstname.length}</p>
          </div>

          <div className="row">
          <form onSubmit={this.handleSubmit} className="col-xs-6 col-md-8" noValidate>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-6">
                  <input type="text" id="firstname" name="firstname" value={this.state.firstname} placeholder="First Name"
                    className={this.state.isError.firstname.length > 6 ? "is-invalid form-control" : "is-valid form-control"} onChange={this.handleChange} required />
          ...
          <div className="modal fade" id="TmersModal" tabIndex="-1" role="dialog" aria-labelledby="TermsModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-scrollable" role="document">
              <div className="modal-content">
                ...
                TouchBistro Inc. (“TouchBistro”, “we”, “us” and terms of similar meaning) provides TouchBistro reservations and online ordering services via websites, mobile sites, widgets and applications (collectively, the “TouchBistro Reservations and Online Ordering Sites”) and the content, features, and services made available by TouchBistro through the TouchBistro Reservations and Online Ordering Sites (the “Services”). These terms and conditions of use (these “Terms”) constitute a legal agreement and are entered into by and between you and TouchBistro. These Terms govern your access to and use of the Services, including any content, functionality, and related services offered on or through the TouchBistro Reservations and Online Ordering Sites.

BY USING THE SERVICES, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTAND AND AGREE TO BE BOUND AND COMPLY WITH THESE TERMS AND CONDITIONS AND OUR PRIVACY NOTICE. IF YOU DO NOT AGREE TO THESE TERMS AND CONDITIONS OR THE PRIVACY NOTICE, YOU MUST NOT ACCESS OR USE THE SERVICES. By using the Services, you represent and warrant that you are the legal age of majority under applicable law to form a binding contract with TouchBistro and meet all of the foregoing eligibility requirements. If you do not meet all of these requirements, you must not access or use the Services. You are solely responsible for ensuring that your use of the Services is in compliance with all applicable laws. THIS AGREEMENT CONTAINS, AMONG OTHER THINGS, AN ARBITRATION PROVISION CONTAINING A CLASS ACTION WAIVER.

We reserve the right in our sole discretion to revise and update these terms and conditions from time to time. Any and all such modifications are effective immediately upon posting and apply to all access to and continued use of the Services. You agree to periodically review the terms and conditions in order to be aware of any such modifications and your continued use shall be your acceptance of these. If you do not agree with the changes, you can cancel your account with us by contacting support@touchbistro.com.  Any changes or modifications will be effective immediately upon posting of the revisions on the TouchBistro Reservations and Online Ordering Sites, and your continued use of Services after such time will constitute your acceptance of such changes or modifications.
...
• Disparage or otherwise negatively represent the Services or do anything that could result in damage or dilution to the goodwill of TouchBistro and its brand;
...
TOUCHBISTRO PROVIDES NO REPRESENTATIONS, WARRANTIES, CONDITIONS OR ENDORSEMENTS OF ANY KIND WITH RESPECT TO THE COMPLETENESS, SECURITY, RELIABILITY, SUITABILITY, ACCURACY, CURRENCY OR AVAILABILITY OF THE SERVICES OR ITS CONTENTS. WITHOUT LIMITING THE FOREGOING, NEITHER TOUCHBISTRO, NOR ANY OF ITS SERVICE PROVIDERS, CONTRACTORS, LICENSORS, LICENSEES OR SUPPLIERS REPRESENT OR WARRANT THAT THE SERVICES, ITS CONTENT, OR ANY SERVICES OR ITEMS FOUND OR ATTAINED THROUGH THE SERVICES WILL BE ACCURATE, RELIABLE, SECURE ERROR-FREE, OR UNINTERRUPTED, THAT DEFECTS WILL BE CORRECTED, OR THAT THE SERVICES ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.

UNDER NO CIRCUMSTANCE WILL TOUCHBISTRO BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, INCLUDING ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF USE AND LOSS OF DATA, WHETHER BASED IN CONTRACT, TORT (INCLUDING NEGLIGENCE) OR OTHERWISE, EVEN IF TOUCHBISTRO WAS ALLEGEDLY ADVISED OR HAD REASON TO KNOW OF THE POSSIBILITY OF SUCH DAMAGES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE, OR INABILITY TO USE, OR RELIANCE ON, THE SERVICES, ANY LINKED WEBSITES OR SUCH OTHER THIRD-PARTY WEBSITES, NOR ANY CONTENT, MATERIALS, POSTING OR INFORMATION PROVIDED THROUGH THE SERVICES.

TO THE EXTENT THE FOREGOING EXCLUSIONS ARE PROHIBITED BY LAW, YOU EXPRESSLY AGREE THAT TOUCHBISTRO’S LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE NATURE OF THE CLAIM WILL AT ALL TIMES BE LIMITED TO ONE HUNDRED CANADIAN DOLLARS ($100).

14. Indemnity and Release.
To the maximum extent permitted by applicable law, you agree to defend, indemnify, and hold harmless TouchBistro, its subsidiaries, affiliates or respective directors, officers, employees, agents or successors (collectively with TouchBistro the “TouchBistro Parties”) from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys’ fees) arising out of or relating to your breach of these Terms or your use of the Services other than as expressly authorized in these Terms. Your interactions with Restaurants and/or any payment processors are solely between you and such party and all claims, injuries, illnesses, damages, liabilities, and costs suffered by you as a result of your interaction with any Restaurant or payment processor or from any promotion, offer, product or service of any Restaurant or payment processor must be resolved directly with Restaurants. You waive and shall not assert any claims or allegations of any nature whatsoever against any TouchBistro Party arising out of or in any way relating to your use of the TouchBistro Reservations and Online Ordering Sites or the Services, including, without limitation, any claims or allegations that any TouchBistro Party should indemnify, defend or hold harmless you or any third party from any claim or allegation arising from your use or other exploitation of the TouchBistro Reservations and Online Ordering Sites or the Services. To the maximum extent permitted by law, you hereby release the TouchBistro Parties from any and all claims arising from your interaction with any Restaurant and/or payment processor. You and TouchBistro understand and agree that the disclaimers, exclusions, and limitations of liability in these Terms are essential elements of this Agreement and that they represent a reasonable allocation of risk. In particular, you understand that TouchBistro would be unable to make the Services available to you except on these terms and agree that this Agreement will survive and apply even if any limited remedy specified in this Agreement is found to have failed of its essential purpose.

15. Communications.
Notices that we give you may be provided in any number of ways, depending on the circumstances. For example, we may email you or telephone you at the contact information you provide in your Registration Data. Or we may post a notice on the TouchBistro Reservations and Online Ordering Sites. When we post notices on the TouchBistro Reservations and Online Ordering Sites, we post them in an area suitable to the notice. It is your responsibility to periodically review the TouchBistro Reservations and Online Ordering Sites for notices. You agree to keep all Registration Data current and up to date.

16. Third Party Content.
The Services include content provided by third parties, including from Restaurants, other users and third-party licensors. All statements and/or opinions expressed in any such third-party content, other than the content provided by TouchBistro, are solely the opinions and the responsibility of the person or entity providing those materials. Such materials do not necessarily reflect the opinion of TouchBistro. Neither TouchBistro nor its subsidiaries, affiliates, and their respective directors, officers, employees, agents, service providers, contractors, licensors, suppliers, successors, and assigns have any responsibility or liability whatsoever to you, or any third party, for the content or accuracy of any third-party materials.

17. Third-Party Websites, Applications and Services.
For your convenience, the Services may provide links or pointers to third-party sites. We make no representations about any other websites that may be accessed from or through the Services. If you choose to access any such sites, you do so at your own risk. We have no control over the contents of any such third-party sites and accept no responsibility for such sites or for any loss or damage that may arise from your use of them. You are subject to any terms and conditions of such third-party sites. The Services allow users to (i) book reservations and make online orders with Restaurants that are not affiliated with TouchBistro (the “TouchBistro Partners”). By using the Services, you grant TouchBistro permission to share account information, reservation and order details, and other information that you provide to TouchBistro with such TouchBistro Partners for the purpose of booking reservations or making online orders with such TouchBistro Partners, and agree to receive emails from such TouchBistro Partners regarding your reservations or online orders. In addition, you acknowledge that TouchBistro may receive account information, reservation and order details, and other information that you provide to the TouchBistro Partners when you utilize the Services via the TouchBistro Partners. You acknowledge that TouchBistro is not affiliated with the TouchBistro Partners, is not responsible for their products and services, and makes no representations, warranties, or guarantees with respect to the TouchBistro Partners. Your use of the TouchBistro Partners’ services will be governed by each TouchBistro Partner’s terms and conditions and privacy policy.

18. Applicable Law and Venue TouchBistro is headquartered in Toronto, Ontario Canada.
You and TouchBistro both benefit from establishing a predictable legal environment in regard to the Services. Therefore, you and TouchBistro explicitly agree that all disputes, claims or other matters arising from or relating to your use of the Services shall be exclusively governed by the laws of the Province of Ontario and the federal laws of Canada applicable therein and the courts sitting at Toronto, Ontario regardless of your domicile, residence or physical location. The parties hereto waive any right to trial by jury in respect of any dispute arising from or related to this agreement. Except where prohibited by applicable law, any claim, dispute or controversy (whether in contract or tort, pursuant to statute or regulation, or otherwise, and whether pre-existing, present or future) involving TouchBistro and arising out of or relating to (a) the Terms; (b) the Services; or (c) oral or written statements, advertisements or promotions relating to the Services or any associated third party services (collectively, a “Claim”), will be referred to and determined by individual arbitration by a single arbitrator (to the exclusion of the courts) sitting at Toronto, Canada in accordance with the Arbitrations Act of Ontario. Arbitration can be initiated by either party delivering to the other party a written Notice of Arbitration invoking this provision. The arbitrator’s authority is limited to claims between you and us alone. Claims may not be joined or consolidated unless you and we consent in writing. An arbitration award and any judgment confirming it will apply only to the specific case and cannot be used in any other case except to enforce the award. The arbitrator’s decision will be final and binding. Each party will bear its own expenses under such arbitration, subject to the authority of the arbitrator to make an award of legal costs in accordance with the arbitrator’s authority. Except where prohibited by applicable law, you waive any right you may have to commence or participate in any class action against TouchBistro related to any Claim and, where applicable, you also agree to opt out of any class proceedings against TouchBistro. Without limiting the foregoing, you and we will not have the right to participate in a representative capacity or as a member of any class pertaining to any Claim subject to arbitration. If you are a resident in Mexico, you hereby expressly waive any right to exercise a class action before a Mexican court against TouchBistro, pursuant to the terms of the Federal Code of Civil Procedure (CódigoFederal de ProcedimientosCiviles) and any other applicable Mexican legislation. If you have a Claim, you should give written notice to arbitrate at the e-mail address specified below or by registered mail to TouchBistro’s head office. If we have a Claim, we will give you notice to arbitrate at your address provided in your Registration Data. To the extent arbitration as described in the immediately preceding paragraph is prohibited by applicable law, you agree that all Claims shall be heard and resolved in a court of competent subject matter jurisdiction located in Toronto, Ontario. You consent to the personal jurisdiction of such courts over you, stipulate to the fairness and convenience of proceeding in such courts and submit to their exclusive jurisdiction, and covenant not to assert any objection to proceeding in such courts. Notwithstanding the foregoing, TouchBistro shall be entitled, at its election, to apply to a court of competent jurisdiction for interim or permanent injunctive relief, a mandatory order, restraining order, or other like relief to restrain an actual or threatened breach of this Agreement and TouchBistro’s rights under it by any party and specifically but not limited to, protection of the intellectual property, information technology, brand, trade-marks, and other proprietary material of TouchBistro or its suppliers or licensors.

19. Termination/Modification of License and Site Offerings.
Notwithstanding any provision of the Terms, TouchBistro reserves the right, without notice and in its sole discretion, without liability to you, to (a) terminate your right to use the Services, or any portion thereof; (b) block or prevent your future access to and use of all or any portion of the Services, (c) change, suspend or discontinue any aspect of the Services; and (d) impose limits on the Services. If you object to any such changes, your sole recourse shall be to cease using the Services. Continued use of the Services following any such changes shall indicate your acknowledgment of and satisfaction with such changes. You agree that TouchBistro shall not be liable to you for any termination of this Agreement or for any effects of any termination of this Agreement. You are always free to discontinue your use of the Services at any time. You understand that any termination of your account may involve deletion of any content stored in your account for which TouchBistro will have no liability whatsoever.

20. Miscellaneous.
If any term or provision of these Terms is invalid, illegal or unenforceable in any jurisdiction, such invalidity, illegality or unenforceability shall not affect any other term or provision of these Terms or invalidate or render unenforceable such term or provision in any other jurisdiction. TouchBistro may assign any or all of its rights hereunder to any party without your consent. You are not permitted to assign any of your rights or obligations hereunder, and any such attempted assignment will be void and unenforceable. The Terms and our Privacy Notice constitute the sole and entire agreement between you and TouchBistro regarding the Services and supersede all prior and contemporaneous understandings, agreements, representations and warranties, both written and oral, regarding such subject matter. No failure to exercise, or delay in exercising, any right, remedy, power or privilege arising from these Terms operates, or may be construed, as a waiver thereof. No single or partial exercise of any right, remedy, power or privilege hereunder precludes any other or further exercise thereof or the exercise of any other right, remedy, power or privilege. The parties confirm that it is their wish that the Terms, as well as any other documents relating to this Terms, including notices, have been and shall be drawn up in the English language only. Les parties reconnaissent avoir convenue que la présente convention ainsi que tous documents, avis et procédures judiciaires qui pourront être exécutés, donnés ou intentées à la suite des présentes ou ayant un rapport, direct ou indirect, avec la présente convention soient rédigée en anglais.

21. Questions, Comments, Notices.
Should you become aware of misuse of the Services, including libelous or defamatory conduct, you must report it to TouchBistro at support@touchbistro.com. All other feedback, comments, questions, requests for technical support, and other communications relating to the Services should be directed to support@touchbistro.com.
